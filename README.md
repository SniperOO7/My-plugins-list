...
**Competition** | My private plugin for competition for skin, you can write a name of skin, set the time how long will be competition, change if everyone can join or only steam group members ... | 
